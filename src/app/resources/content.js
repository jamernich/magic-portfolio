...
const person = {
    ...
    languages: ['English', 'Bahasa','Jawir']  // optional: Leave the array empty if you don't want to display languages
}
...
const about = {
    ...
    intro: {
        display: true,
        title: 'Introduction',
        description: <>Jamer is a Ngawi-based design engineer with a passion for transforming complex challenges into simple, elegant design solutions. Her work spans digital interfaces, interactive experiences, and the convergence of design and technology.</>
    },
    work: {
    ...
    technical: {
        ...
        skills: [
            {
                title: 'Figma',
                description: <>Opsss. Im not an expert in figma, this was all designed by someone else.</>,
